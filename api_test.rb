...
response = Typhoeus.get("http://private-5e584-themoviedb.apiary.io/3/configuration", {:accept => "application/json"})
puts response
...
#   response = Typhoeus.get("https://api.themoviedb.org/3/movie/550?api_key=2e883d4e1097d6b6bb01747b4ae8df76/search/movie",:params => {:query => search_str})
